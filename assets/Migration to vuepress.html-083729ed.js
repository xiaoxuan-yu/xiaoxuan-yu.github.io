import{_ as t,X as p,Y as l,$ as s,a0 as n,a1 as c,Z as a,F as o}from"./framework-1841726a.js";const u={},i=a(`<p>为了更好的性能和拓展性，转战 <code>vuepress</code> 。</p><ul><li>初始化</li></ul><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">npm</span> init vuepress-theme-hope@next <span class="token punctuation">[</span>dir<span class="token punctuation">]</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,3),r=s("code",null,"[dir]",-1),d=s("code",null,"blog",-1),k={href:"https://vuepress-theme-hope.github.io/v2/zh/guide/",target:"_blank",rel:"noopener noreferrer"},v=a(`<ul><li>部署</li></ul><p>使用 Github Action ，同步生成 <code>gh-pages</code> 分支并部署到 Github Pages 和远端服务器。</p><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果这样进行最终部署，那么仅需要上传 <code>[dir]\\src</code> 即可完成文档的自动生成和部署，此时 <code>master</code> (或 <code>main</code>) 分支只含有编写的博客文档数据。</p>`,4);function m(b,h){const e=o("ExternalLinkIcon");return p(),l("div",null,[i,s("p",null,[n("其中的 "),r,n(" 为初始化所用的目录名称，如 "),d,n(" 等。随后参照"),s("a",k,[n("主题文档"),c(e)]),n("进行样式、信息和组件的配置即可。")]),v])}const _=t(u,[["render",m],["__file","Migration to vuepress.html.vue"]]);export{_ as default};
